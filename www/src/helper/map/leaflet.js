...
L.Mixin.Events.fire = L.Mixin.Events.fireEvent;(function() {
...
L.TileLayer = L.Class.extend({
	...
	_tileOnError: function(e) {
		...
		var givenUrl = layer.fire('tileerror', {tile: this, url: this.src});
...
L.Map.include({
	...
	_handleGeolocationResponse: function(pos) {
		...
		if (this._setViewOnLocate) {
			var zoom = this._zoom; //Math.min(this._zoom, this.getBoundsZoom(bounds), this._maxLocateZoom);
